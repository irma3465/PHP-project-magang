...
$mahasiswa = $db->query("SELECT * FROM mahasiswa WHERE id_mahasiswa = '$id_mahasiswa'");
$mahasiswa = $mahasiswa->fetch_assoc();
if (empty($mahasiswa)) {
   echo "<script>alert('mahasiswa not found.');window.location.href='index.php?page=pages/mahasiswa/index';</script>";
}
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Update prodi
   $sql = "UPDATE mahasiswa SET id_prodi='$id_prodi', nama_mahasiswa = '$nama_mahasiswa', nim ='$nim', email= '$email', tgl_lahir = '$tgl_lahir', semester= '$semester', alamat = '$alamat' WHERE id_mahasiswa = $id_mahasiswa";
   if ($db->query($sql) === TRUE) {
      echo "<script>alert('mahasiswa updated successfully.');window.location.href='index.php?page=pages/mahasiswa/index';</script>";
   } else {
...
<div class="row">
   <div class="col-md-6">
      <div class="card">
         <div class="card-body">
            <h5 class="card-title mb-4">Update data mahasiswa</h5>
            <?php if (isset($error)): ?>
