      ...
      <div class="card">
         <div class="card-body">
            ...
            <div class="form-group">
                  ...
                  <select name="id_jurusan" id="" class="form-control p-input" required>
                     <option value="">--select jurusan</option>
                     <?php foreach($jurusan as $item) :  ?>
                        <option value="<?= $item['id_jurusan'] ?>" <?php echo $item['id_jurusan'] == $prodi['id_jurusans'] ? 'selected' : '' ?>><?= $item['nama_jurusan'] ?></option>
                        <?php endforeach; ?>
                  </select>
               </div>
               <div class="form-group">
                  <label for="nama_prodi">Nama prodi </label>
                  <input type="text" class="form-control p-input" id="nama_prodi" placeholder="Masukkan nama prodi" name="nama_prodi" required value="<?=$jurusan['nama_jurusan']?>">
               </div>
